...
class TopUpBackUpPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Form Pengisian Top Up'),
      ),
      body: TopUpBackUp(),
    );
  }
...
class TopUpBackUp extends StatefulWidget {
  @override
  _TopUpBackUpState createState() => _TopUpBackUpState();
}

class _TopUpBackUpState extends State<TopUpBackUp> {
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  labelText: 'Nominal Dana Yang Top Up',
                  prefixText: 'Rp',
                ),
              ),
              // TextFormField(
